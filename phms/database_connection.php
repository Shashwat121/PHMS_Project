...
$connect = new PDO("mysql:host=localhost;charset=utf8mb4", "Server_Username", "Server_Password");
$statement = $connect->prepare('use Database_Name');
$statement->execute();
...
{
	$statement = $connect->prepare('use hms');
    $statement->execute();
