...
$password1 = trim($_POST["npass"]);
$chat_pass = password_hash($password1, PASSWORD_DEFAULT);
$query_chat = mysqli_query($con,"insert into login(username,password,doc_status,name) values('$docemail','$chat_pass','$doc_status','$docname')");
...
$body = "Dear Dr.$docname, your account has been activated in the Patient Health Monitoring System.\nNow you may login to your account to monitor your patients.\nYour login details are as follows:\nusername: $docemail \npassword: $pass.\n\n Thank you.";
$headers = "FROM: Patient Health Monitoring <patient-healthdata@healthmonitoring101.in>\r\n";

if (mail($to_email, $subject, $body,$headers,'-fpatient-healthdata@healthmonitoring101.in')) {
