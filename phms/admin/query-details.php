...
$from = "phms-complaints@healthmonitoring101.in";
$to_email = $docemail;
$subject = "Patient Health Monitoring System Complaints Update";
$body = "$adminremark \nThank you";
$headers = "FROM: Patient Health Monitoring <phms-complaints@healthmonitoring101.in>\r\n";
mail($to_email, $subject, $body,$headers,'-fphms-complaints@healthmonitoring101.in');
