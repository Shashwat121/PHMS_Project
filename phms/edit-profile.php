<!-- freah copy as of 2nd may has to be uploaded on godaddy -->
...
<?php if($msg) { echo htmlentities($msg);}?> </h5>
									...
									<?php
$sql=mysqli_query($con,"select * from users where id='".$_SESSION['pid']."'");
...
<div class="form-group">
		...
		<input type="text" name="city" class="form-control" required="required"  value="<?php echo htmlentities($data['city']);?>" >
														...
														<div class="form-group">
																...
																<input type="text" name="state" class="form-control" required="required"  value="<?php echo htmlentities($data['state']);?>" >
																												</div>
																												<div class="form-group">
																																											<label for="country">
																																												 Country
																																											</label>
																														<input type="text" name="country" class="form-control" required="required"  value="<?php echo htmlentities($data['country']);?>" >
																																										</div>
...
<select name="gender" class="form-control"  readonly="readonly"  required="required" >
