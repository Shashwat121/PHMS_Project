...
echo "<script>alert('Valid details. You are being redirected to reset your passoword. Please press on OK');</script>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> PHMS | Patient Password Recovery</h2></a>
				</div>
